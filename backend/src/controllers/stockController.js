...
exports.createStockItem = async (req, res, next) => {
    ...
    try {
        ...
        const { name, quantity, properties } = req.body;
        console.log(`[StockCtrl] Tentando criar item na loja ${storeId}:`, { name, quantity, properties });
        ...
        // Cria o item passando o objeto properties (ou um objeto vazio)
