...
class AppPrefs {
  ...
  static const String propGroupId = 'groupId'; // Adicionado para suporte a grupos
  ...
  static Future<List<String>> getItemProperties() async {
    ...
    return prefs.getStringList(_itemPropertiesKey) ??
        [propName, propQuantity, propCategory, propImage, propGroupId]; // Adicionado groupId ao padrão
  }
